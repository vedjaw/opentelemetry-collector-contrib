...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage v0.157.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.157.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sinventory v0.157.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sleaderelectortest v0.157.0
	...
	go.opentelemetry.io/collector/extension/xextension v0.157.1-0.20260730171426-4aa1b2d9586b
	go.opentelemetry.io/collector/filter v0.157.1-0.20260730171426-4aa1b2d9586b
